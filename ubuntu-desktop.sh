...
# Utilities
sudo apt-get -y install virtualbox-ose tasque liferea artha cryptsetup sqlite3 sqlite3-doc conduit istanbul contacts keepassx hamster-applet getmail4 openjdk-6-jre-headless
